...
function loginFunction(_x, _x2) {
  return _loginFunction.apply(this, arguments);
}
function _loginFunction() {
  _loginFunction = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(email, password) {
    var response, _t;
...
function logoutFunction() {
  return _logoutFunction.apply(this, arguments);
}
function _logoutFunction() {
  _logoutFunction = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          console.log('hello');
          url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/users/update-password' : 'http://127.0.0.1:8000/api/v1/users/updateMe'; // console.log(data);
          _context.p = 1;
          _context.n = 2;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 2:
          response = _context.v;
          if (response.data.status === 'success') {
            (0, _alert.showAlert)('success', 'update');
          }
          _context.n = 4;
          break;
        case 3:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51RZnSHAIj4yb6EHXKL3bfJExhXRIK2eLuWlizHvPormJQQl6a7dsRNVTb2nXNv5ilPDaSxO1NDaVKGwFk4y2Fevs006Qss5exN');
...
var bookTourButton = document.getElementById('book_tour');
//values
console.log('updateData');
if (logInForm) {
...
if (updateData) {
  ...
  updateData.addEventListener('submit', function (e) {
    ...
    (0, _updateData.updateUserData)(formData, 'userData');
  });
}
if (updatePassword) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _context.n = 1;
            return (0, _updateData.updateUserData)({
              password: password,
...
if (logout) {
  logout.addEventListener('click', _logout.default);
}
if (bookTourButton) {
